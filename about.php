    ...
    <section>
        <div class="container">
            <div class="section-title  ">
                <!-- <h4 class=" text-uppercase text-primary text-center"  style="letter-spacing: 5px;">About Us</h4> -->
                <h1 class="text-center">Brahmandnayak Agro company Import and Export</h1>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8  mt-1">
                    <div class="">
                        <h2>Our Mission </h2>
                        <p>"At <a href="/">Brahmandnayak Agro company Import and Export</a>Our mission is to connect farmers and producers from across the globe with consumers who seek the highest quality agricultural products. We strive to enhance the value chain by ensuring that every product we handle meets stringent quality standards and reaches our customers in optimal condition.</p>
                    </div>
                </div>
                <div class="col-lg-4 mt-1">
                    <img src="img/mission.jpg" height="auto" width="100%" alt="">
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-4 mt-1">
                    <img src="img/vission.jpg" height="auto" width="100%" alt="">
                </div>
                <div class="col-lg-8  mt-1">
                    <div class="">
                        <h2>Our Vision</h2>
                        <p>"At <a href="/">Brahmandnayak Agro company Import and Export</a>, our vision is to become a leading global force in the agricultural trade industry, renowned for our unwavering commitment to excellence, innovation, and sustainability.</p>
                    </div>
                </div>
            </div>
        </div>
